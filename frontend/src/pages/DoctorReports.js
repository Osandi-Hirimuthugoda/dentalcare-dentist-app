...
const DoctorReports = () => {
  ...
  return (
    <div className="doctor-reports-layout">
      <DoctorSidebar />
      <div className="doctor-reports-content">
        <motion.h2
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          className="doctor-reports-title"
        >
          Clinic Reports
        </motion.h2>
              ...
              {stats.map((s, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="stat-card-value" style={{ color: s.color }}>{s.value}</h3>
                  </motion.div>
                );
              })}
            </div>
            ...
            >
              ...
              <div style={{ marginTop: "1.5rem", display: "flex", gap: "1rem", flexWrap: "wrap" }}>
                <div style={{ 
                  ...
                  <div style={{ fontSize: "0.875rem", color: "#6b7280", marginBottom: "0.25rem" }}>Completion Rate</div>
                ...
                <div style={{ 
                  ...
                  <div style={{ fontSize: "0.875rem", color: "#6b7280", marginBottom: "0.25rem" }}>Pending Cases</div>
